...
namespace VirtoCommerce.CacheModule.Web
{
    ...
    {     
        ...
        public override void PostInitialize()
        {
            ...
            var cacheStoreServiceDecorator = new StoreServicesDecorator(_container.Resolve<IStoreService>(), cacheManagerAdaptor);
            _container.RegisterInstance<IStoreService>(cacheStoreServiceDecorator);
